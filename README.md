...
Open the SetBuild.py script.

Enter your email in the config section (used for SEC request headers).

Ensure you have a CSV of tickers named sp500_yfin.csv.

Run SetBuild.py to download filings for the specified tickers, covering the years 2015–2025.
